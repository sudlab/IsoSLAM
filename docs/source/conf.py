...
autodoc_mock_imports = ["numpy", "pandas", "matplotlib", "seaborn", "scipy", "skimage"]

# -- Project information -----------------------------------------------------

project = "IsoSLAM"
copyright = "2024, IsoSLAM authors"
author = "IsoSLAM authors"
...
latex_documents = [
    (master_doc, "IsoSLAM.tex", "IsoSLAM Documentation", "IsoSLAM Authors", "manual"),
]
...
man_pages = [(master_doc, "IsoSLAM", "IsoSLAM Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        project,
        "IsoSLAM Documentation",
        author,
        project,
        "Processing SLAMSeq data.",
        "Miscellaneous",
    ),
]
